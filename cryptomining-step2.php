...
<p>Select your options and click next for simple instructions on how to create a Linux CPU miner in a few minutes. You will need to download the windows client (or Linux) for the wallet where all the coins will be accumulated. Then copy one of the receiving addresses and paste it here. (Better keeping the coins in your own wallet locally than on a deployed cloud miner)</p>
  <form action="cryptomining-step3.php" method="GET" enctype="multipart/form-data" >
    <p>
  ...
  <label>Enter the amount of cores you will be using : </label> 
    ...
    <p>
          ...
          <input type="hidden" name="capital" value="<?php echo $_GET['capital']; ?>">
      <input name="submit" type="submit" id="submit" formaction="cryptomining-step3.php"
