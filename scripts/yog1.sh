...
cd minecraft 
wget http://www.creeperrepo.net/FTB2/modpacks%5EMonster%5E1_1_1%5EMonsterServer.zip -O minecraft.zip 
...
screen -d -m java -Xmx1500M -Xms1500M -jar FTBServer-1.6.4-965.jar nogui" | tee -a ServerStartCustom.sh 
